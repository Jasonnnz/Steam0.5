...
# GAMES 
paladins = Game.create(name: "Paladins" ,genre: "FPS", image: "./images2/paladins2.jpg")
...
# USERBADGE
ub1 = UserBadge.create(user_id: 1, badge_id: 29)
ub2 = UserBadge.create(user_id: 2, badge_id: 30)
...
wow5 = Badge.create(name: "Bruno's Medal", image: "./badgeimage/wo/wor/wo5.jpg", description: "Bruno's Medal", game_id: 12)
wow6 = Badge.create(name: "Master", image: "./badgeimage/wo/wor/wo6.jpg", description: "Master", game_id: 12)
wow7 = Badge.create(name: "Knispel's Medal", image: "./badgeimage/wo/wor/wo7.jpg", description: "Knispel's Medal", game_id: 12)
wow8 = Badge.create(name: "Stark's Medal", image: "./badgeimage/wo/wor/wo8.jpg", description: "Stark's Medal", game_id: 12)
wow9 = Badge.create(name: "Promising Fighter", image: "./badgeimage/wo/wor/wo9.jpg", description: "Promising Fighter", game_id: 12)
wow10 = Badge.create(name: "Oskin's Medal", image: "./badgeimage/wo/wor/wo10.jpg", description: "Oskin's Medal", game_id: 12)
## League of Legend
l1 = Badge.create(name: "Warden", image: "./badgeimage/le/ler/le1.jpg", description: "Controlling enemies and the flow of battle", game_id: 2)
l2 = Badge.create(name: "Protector", image: "./badgeimage/le/ler/le2.jpg", description: "Keeping yourself and allies in the fight", game_id: 2)
l3 = Badge.create(name: "Empress", image: "./badgeimage/le/ler/le3.jpg", description: "Superior demonstration of skill in the heat of the battle", game_id: 2)
l4 = Badge.create(name: "Trickster", image: "./badgeimage/le/ler/le4.jpg", description: "Deceitful mind games or premeditated chaos", game_id: 2)
l5 = Badge.create(name: "Warrior", image: "./badgeimage/le/ler/le5.jpg", description: "Crushing foes mercilessly on the battlefield", game_id: 2)
l6 = Badge.create(name: "Guide", image: "./badgeimage/le/ler/le6.jpg", description: "Following the path to victory, or opening one for allies", game_id: 2)
## Apex badges
...
p3 = Badge.create(name: "Not Like This", image: "./badgeimage/pl/plr/pl3.jpg", description: "Kill an enemy player while you are at or below 50 Health", game_id: 1)
...
p6 = Badge.create(name: "Double Kills Bronze", image: "./badgeimage/pl/plr/pl6.jpg", description: "10 Double Kills", game_id: 1)
p7 = Badge.create(name: "Champion Mastery I", image: "./badgeimage/pl/plr/pl7.jpg", description: "1 Champion at Mastery 5", game_id: 1)
p8 = Badge.create(name: "Give 110 Percent", image: "./badgeimage/pl/plr/pl8.jpg", description: "Get a killing blow after the round has ended", game_id: 1)
p9 = Badge.create(name: "I Like Big Numbers", image: "./badgeimage/pl/plr/pl9.jpg", description: "Deal more than 100,000 damage during a match", game_id: 1)
p10 = Badge.create(name: "Send Off", image: "./badgeimage/pl/plr/pl10.jpg", description: "Kill a player with an environmental hazard", game_id: 1)
## Overwatch badges
...
pd3 = Badge.create(name: "I Want to Get Away", image: "./badgeimage/pd/pdr/pd3.jpg", description: "Jump. Unlocks the 'Funnyman' mask", game_id: 4)
...
pd6 = Badge.create(name: "Tip the Scales", image: "./badgeimage/pd/pdr/pd6.jpg", description: "Add money to the scales", game_id: 4)
pd7 = Badge.create(name: "Guilty of Crime", image: "./badgeimage/pd/pdr/pd7.jpg", description: "Reach reputation level 10", game_id: 4)
pd8 = Badge.create(name: "Would You Like Your Receipt?", image: "./badgeimage/pd/pdr/pd8.jpg", description: "Buy a weapon for the first time", game_id: 4)
pd9 = Badge.create(name: "Armed to the Teeth", image: "./badgeimage/pd/pdr/pd9.jpg", description: "Modify a weapon for the first time", game_id: 4)
pd10 = Badge.create(name: "Smooth Criminal", image: "./badgeimage/pd/pdr/pd10.jpg", description: "Reach reputation level 25", game_id: 4)
## Rust badges
...
wf6 = Badge.create(name: "Counter Intelligence", image: "./badgeimage/wa/war/wa6.jpg", description: "Solve a Cipher in under 5 seconds", game_id: 11)
wf7 = Badge.create(name: "Special Agent", image: "./badgeimage/wa/war/wa7.jpg", description: "Solve 10 Ciphers", game_id: 11)
wf8 = Badge.create(name: "We Shape Our Tools", image: "./badgeimage/wa/war/wa8.jpg", description: "Apply a Mod to a weapon or Warframe", game_id: 11)
wf9 = Badge.create(name: "Weaponsmith", image: "./badgeimage/wa/war/wa9.jpg", description: "Build an item in the Foundry", game_id: 11)
wf10 = Badge.create(name: "Nestegg", image: "./badgeimage/wa/war/wa10.jpg", description: "Earn 10,000 Credits", game_id: 11)
## Minecraft badges
...
bf6 = Badge.create(name: "Combat Engineer", image: "./badgeimage/bf/bfr/b6.jpg", description: "In Multiplayer, build 10 fortifications in a round", game_id: 7)
bf7 = Badge.create(name: "Lovely Complete Under No Flag War Story", image: "./badgeimage/bf/bfr/b7.jpg", description: "Complete Under No Flag War Story", game_id: 7)
bf8 = Badge.create(name: "Eager Beaver", image: "./badgeimage/bf/bfr/b8.jpg", description: "Earn 150,000 score as a Player", game_id: 7)
bf9 = Badge.create(name: "Call ’em in!", image: "./badgeimage/bf/bfr/b9.jpg", description: "In Multiplayer, as a squad leader call in 2 reinforcements in a round", game_id: 7)
bf10 = Badge.create(name: "Store fuglar fanga ingi flugor", image: "./badgeimage/bf/bfr/b10.jpg", description: "Complete Nordlys War Story", game_id: 7)
bf11 = Badge.create(name: "Ou La Mort", image: "./badgeimage/bf/bfr/b11.jpg", description: "Complete Tirailleur War Story", game_id: 7)
bf12 = Badge.create(name: "Elite", image: "./badgeimage/bf/bfr/b12.jpg", description: "Earn 500,000 score as a Player", game_id: 7)
## Pulsar badges
